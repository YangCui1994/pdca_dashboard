...
class FrontendStaticTests(unittest.TestCase):
    ...
    def test_index_is_all_items_board(self):
        ...
        self.assertIn("newTaskUseAi", html)
        self.assertIn("可选：使用 AI 整理", html)
        ...
        self.assertIn("/api/work-item-delete", js)
        self.assertIn("deleteWorkItem", js)
